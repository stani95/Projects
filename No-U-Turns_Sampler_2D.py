...
for m in range(num_samples):
	if (m+1)%5==0:
		print ("Samples drawn so far:", m+1, "/", num_samples)
...
fig, ax = plt.subplots()
CS_x = ax.contour(x, y, 200000000000*distr(x,y), zorder=1, levels=[i**(1.7)/1.1+1 for i in range(35)])
plt.scatter(samples_x, samples_y, c='blue', s=5)
